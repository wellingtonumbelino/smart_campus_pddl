(define (problem smart-campus-scenario)
  ...
  (:init
    ...
    (at 1.0 (= (people_in_room bl2_sl1) 35))
    (at 1.0 (= (people_in_room bl2_sl4) 20))
    (at 1.0 (= (people_in_room bl2_sl2) 25))
    (at 1.0 (= (people_in_room bl2_library) 2))
    (at 1.0 (= (people_in_room bl3_sl1) 15))
    (at 1.0 (= (people_in_room bl3_sl2) 30))
    (at 1.0 (= (people_in_room bl3_sl3) 20))
    (at 1.0 (= (people_in_room bl3_sl4) 25))

    (at 2.0 (= (people_in_room bl1_sl2) 4))
    (at 2.0 (= (people_in_room bl1_sl3) 26))
    (at 2.0 (= (people_in_room bl2_library) 6))

    (at 3.0 (= (people_in_room bl1_sl_coord_com) 1))
    (at 3.0 (= (people_in_room bl2_sl3) 30))
    (at 3.0 (= (people_in_room bl4_sl1) 32))
    (at 3.0 (= (people_in_room bl4_sl2) 15))
    (at 3.0 (= (people_in_room bl4_sl3) 36))
    (at 3.0 (= (people_in_room bl4_sl4) 25))
    (at 3.0 (= (people_in_room bl4_lab_prototype) 5))
    (at 3.0 (= (people_in_room bl4_sl_projects) 15))
    (at 3.0 (= (people_in_room bl4_lab_arch) 10))
    (at 3.0 (= (people_in_room bl4_lab_electronics) 5))
    (at 3.0 (= (people_in_room bl4_lab_info) 15))
    (at 3.0 (= (people_in_room bl4_lab_robotic) 12))
    (at 3.0 (= (people_in_room bl4_lab_pos) 3))

    (at 5.0 (= (people_in_room bl1_sl_pet_si) 3))
    (at 5.0 (= (people_in_room bl1_lab1) 20))
    (at 5.0 (= (people_in_room bl1_lab2) 30))
    (at 5.0 (= (people_in_room bl2_library) 2))

    (at 7.0 (= (people_in_room bl1_lab3) 25))
    (at 7.0 (= (people_in_room bl1_lab4) 15))
    (at 7.0 (= (people_in_room bl2_library) 10))
    ...
    (at 10.0 (= (people_in_room bl3_lab_info_design) 15))
    (at 10.0 (= (people_in_room bl3_lab_info) 20))
    (at 10.0 (= (people_in_room bl2_library) 3))
    ...
    (at 15.0 (= (people_in_room bl2_sl1) 0))
    (at 15.0 (= (people_in_room bl2_sl2) 0))
    (at 15.0 (= (people_in_room bl2_sl3) 0))
    (at 15.0 (= (people_in_room bl2_sl4) 0))
    (at 15.0 (= (people_in_room bl3_lab_info_design) 0))
    (at 15.0 (= (people_in_room bl3_lab_info) 0))
    (at 15.0 (= (people_in_room bl2_library) 0))
    (at 15.0 (= (people_in_room bl3_sl1) 0))
    (at 15.0 (= (people_in_room bl3_sl2) 0))
    (at 15.0 (= (people_in_room bl3_sl3) 0))
    (at 15.0 (= (people_in_room bl3_sl4) 0))
    (at 15.0 (= (people_in_room bl4_sl1) 0))
    (at 15.0 (= (people_in_room bl4_sl2) 0))
    (at 15.0 (= (people_in_room bl4_sl3) 0))
    (at 15.0 (= (people_in_room bl4_sl4) 0))
    (at 15.0 (= (people_in_room bl4_lab_prototype) 0))
    (at 15.0 (= (people_in_room bl4_sl_projects) 0))
    (at 15.0 (= (people_in_room bl4_lab_arch) 0))
    (at 15.0 (= (people_in_room bl4_lab_electronics) 0))
    (at 15.0 (= (people_in_room bl4_lab_info) 0))
    (at 15.0 (= (people_in_room bl4_lab_robotic) 0))
    (at 15.0 (= (people_in_room bl4_lab_pos) 0))
  )
